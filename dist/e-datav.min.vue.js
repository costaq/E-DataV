...
(function (global, factory) {
    ...
    */
    ...
    var _templateObject$9, _templateObject2$5, _templateObject3$2, _templateObject4$2;
    var position = css(_templateObject$9 || (_templateObject$9 = _taggedTemplateLiteral(["\n    position: relative;\n    width: 100%;\n    height: 100%;\n"])));
    var BorderContent = styled.div(_templateObject2$5 || (_templateObject2$5 = _taggedTemplateLiteral(["\n    ", "\n"])), function () {
      return position;
    });
    var BorderSvgContainer = styled.svg(_templateObject3$2 || (_templateObject3$2 = _taggedTemplateLiteral(["\n    position: absolute;\n    width: 100%;\n    height: 100%;\n    top: 0px;\n    left: 0px;\n"])));
    var BorderBox = styled.div(_templateObject4$2 || (_templateObject4$2 = _taggedTemplateLiteral(["\n    ", "\n"])), function () {
      return position;
    });
    ...
    var script$6 = {
      name: 'EBorderBox2',
      components: {
        BorderContainer: BorderContainer$1
      },
      mixins: [autoResize],
      props: {
        /**
    ...
    var BorderContainer = styled('div', borderContainerProps)(_templateObject$7 || (_templateObject$7 = _taggedTemplateLiteral(["\n    --color: ", ";\n    border-radius: 20px;\n    position: relative;\n    width: 100%;\n    height: 100%;\n    border: ", "px solid var(--color);\n    background-color: ", ";\n    box-shadow: 0 0 15px var(--color), 0 0 15px var(--color) inset;\n"])), function (props) {
      return props.borderColor;
    }, function (props) {
      return props.borderWidth;
    }, function (props) {
    ...
    var BorderTitle = styled('div', borderTitleProps)(_templateObject2$4 || (_templateObject2$4 = _taggedTemplateLiteral(["\n    --height: ", ";\n    --width: ", "\n    --color: ", ";\n    color: ", ";\n    background-color: ", ";\n    position: absolute;\n    top: calc(var(--height) * -0.5);\n    left: ", ";\n    right: ", ";\n    height: var(--height);\n    font-weight: bold;\n    line-height: var(--height);\n    font-size: ", "px;\n    filter: drop-shadow(0 0 8px var(--color));\n    padding: 0 10px;\n    transform: ", ";\n\n    ::before {\n        content: '';\n        position: absolute;\n        right: 100%;\n        display: inline-block;\n        width: 0;\n        height: 0;\n        border-top: ", ";\n        border-bottom: ", ";\n        border-left: var(--height) solid transparent;\n    }\n\n    ::after {\n        content: '';\n        position: absolute;\n        left: 100%;\n        display: inline-block;\n        width: 0;\n        height: 0;\n        border-top: ", ";\n        border-right: var(--height) solid transparent;\n        border-bottom: ", ";\n    }\n"])), function (props) {
      ...
      return props.textPosition === 'left' ? 'calc(var(--height) * 1.5)' : props.textPosition === 'center' ? '50%' : 'auto';
    }, function (props) {
      return props.textPosition === 'right' ? 'calc(var(--height) * 1.5)' : 'auto';
    }, function (props) {
      return props.fontSize;
    }, function (props) {
      return props.textPosition === 'center' ? 'translateX(calc(var(--width) * -0.5))' : '';
    }, function (props) {
      return props.textPosition === 'right' ? '' : 'var(--height) solid var(--color)';
    }, function (props) {
      return props.textPosition === 'right' ? 'var(--height) solid var(--color)' : '';
    }, function (props) {
      return props.textPosition === 'left' ? '' : 'var(--height) solid var(--color)';
    }, function (props) {
      return props.textPosition === 'left' ? 'var(--height) solid var(--color)' : '';
    });
    ...
    var script$5 = {
      ...
      mounted: function mounted() {
        var _this = this;
        this.$nextTick(function (_) {
          var dom = _this.$refs[_this.titleRef];
          _this.titleSize = {
        ...
        [
          _c(
            "border-title",
            {
              ref: _vm.titleRef,
              attrs: {
                width: _vm.titleSize.width,
                height: _vm.titleSize.height,
                "font-size": _vm.fontSize,
                "font-color": _vm.fontColor,
                "text-position": _vm.textPosition,
                "background-color": _vm.borderColor,
              },
            },
    ...
    var BoxContent = styled('div', boxContentProps)(_templateObject$6 || (_templateObject$6 = _taggedTemplateLiteral(["\n    height: 100%;\n    width: 100%;\n    position: absolute;\n    top: 0px;\n    left: 0px;\n    background: ", ";\n    border-radius: 100%;\n    overflow: hidden;\n\n    .percent {\n        position: absolute;\n        left: 0;\n        top: 0;\n        z-index: 3;\n        width: 100%;\n        height: 100%;\n        display: flex;\n        display: -webkit-flex;\n        align-items: center;\n        justify-content: center;\n        color: ", ";\n        font-size: ", "px;\n    }\n"])), function (props) {
      return props.backgroundColor;
    }, function (props) {
      return props.fontColor;
    }, function (props) {
    ...
    var GlobalBox = styled.div(_templateObject$5 || (_templateObject$5 = _taggedTemplateLiteral(["\n    position: relative;\n    width: 100%;\n    height: 100%;\n"])));
          ...
          _c(
            ...
            [
              ...
              _c(
                ...
                {
                  attrs: {
                    symbolId: _vm.uniqueId,
                    value: _vm.displayVal,
                    waveColors: _vm.waveColors,
                  },
                },
                [
                  _c(
    ...
    var script$3 = {
      ...
      methods: {
        initItemSize: function initItemSize() {
          var _this2 = this;
          this.$nextTick(function () {
            var children = _this2.$children[0].$children;
            _this2.items = children;
            var rows = Math.ceil(children.length / _this2.columns);
            _this2.itemSize.width = _this2.width > 0 ? _this2.width / _this2.columns - _this2.margin * 2 : 0;
            _this2.itemSize.height = _this2.height > 0 ? _this2.height / rows - _this2.margin * 2 : 0;
          });
        },
        initSelectedValue: function initSelectedValue() {
          ...
          this.$nextTick(function () {
            if (_this3.value) {
              _this3.selectedValue = _this3.value;
            } else if (_this3.items && _this3.items.length > 0) {
              _this3.selectedValue = _this3.items[0].value;
            }
          });
        }
      }
    ...
    var __vue_render__$3 = function () {
      ...
      return _c(
        "tab-container",
        {
          ...
          class: _vm.ref,
          attrs: {
            symbolId: _vm.symbolId,
            length: _vm.itemSize.width + _vm.itemSize.height,
          },
        },
        [_vm._t("default")],
        2
    ...
    var TabItem = styled('div', TabItemProps)(_templateObject$3 || (_templateObject$3 = _taggedTemplateLiteral(["\n    position: relative;\n    height: ", "px;\n    width: ", "px;\n    float: left;\n    margin: ", "px;\n    cursor: pointer;\n\n    &.active {\n        rect {\n            stroke-dasharray:", "; \n            animation: blinker-active-", " ", "s linear infinite;\n        }\n    }\n\n    &:hover {\n        rect {\n            animation: blinker-hover-", " ", "s linear infinite;\n        }\n    }\n\n    rect {\n        height: ", "px;\n        width: ", "px;\n        fill: ", ";\n        stroke-dasharray: 0 10000;\n        stroke-dashoffset: 0;\n        stroke-width: 3px;\n    }\n"])), function (props) {
      return props.height;
    }, function (props) {
      return props.width;
    }, function (props) {
    ...
    var ItemBorder = styled.svg(_templateObject2$2 || (_templateObject2$2 = _taggedTemplateLiteral(["\n    position: absolute;\n    width: 100%;\n    height: 100%;\n    left: 0;\n    top: 0;\n"])));
    var ItemText = styled.span(_templateObject3$1 || (_templateObject3$1 = _taggedTemplateLiteral(["\n    margin: 0 5px;\n"])));
    var ItemIcon = styled.span(_templateObject4$1 || (_templateObject4$1 = _taggedTemplateLiteral([""])));
    var ItemContent = styled('div', TabItemContentProps)(_templateObject5$1 || (_templateObject5$1 = _taggedTemplateLiteral(["\n    position: absolute;\n    width: 100%;\n    height: 100%;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    font-size: ", "px;\n    color: ", ";\n"])), function (props) {
      return props.fontSize;
    }, function (props) {
      return props.fontColor;
    });
    ...
    var script$2 = {
      ...
      methods: {
        handleClick: function handleClick(event, value) {
          var _this = this;
          this.$nextTick(function () {
            _this.dispatch('ETab', 'handleChange', value);
          });
        }
      }
    };
    ...
    var __vue_render__$2 = function () {
      ...
      return _c(
        ...
        {
          key: _vm.value,
          class: _vm._tabGroup.selectedValue === _vm.value ? "active" : "",
          attrs: {
            margin: _vm._tabGroup.margin,
            width: _vm._tabGroup.itemSize.width,
            height: _vm._tabGroup.itemSize.height,
            duration: _vm._tabGroup.duration,
            "font-color": _vm._tabGroup.fontColor,
            "font-size": _vm._tabGroup.fontSize,
            "background-color": _vm._tabGroup.backgroundColor,
            symbolId: _vm._tabGroup.symbolId,
          },
          on: {
            click: function ($event) {
              return _vm.handleClick($event, _vm.value)
            },
          },
        },
        [
          _c(
            ...
            [
              _c(
                ...
                [
                  _c(
                    ...
                    {
                      attrs: {
                        id: "svg-blur-" + _vm._tabGroup.symbolId,
                        x: "0",
                        y: "0",
                        width: _vm._tabGroup.itemSize.width,
                        height: _vm._tabGroup.itemSize.height,
                  ...
                  _c(
                    ...
                    {
                      attrs: {
                        id: "svg-gradient-" + _vm._tabGroup.symbolId,
                    ...
                    _vm._l(_vm._tabGroup.borderColors, function (color, i) {
                      return _c("stop", {
                        key: i,
                        attrs: {
                          offset:
                            (i / (_vm._tabGroup.borderColors.length - 1)) * 100 +
                            "%",
                          "stop-color": color,
                        },
                      })
              ...
              _c("rect", {
                attrs: {
                  filter: "url(#svg-blur-" + _vm._tabGroup.symbolId + ")",
                  stroke: "url(#svg-gradient-" + _vm._tabGroup.symbolId + ")",
                  rx: "10",
                },
              }),
            ]
          ...
          _c(
            "item-content",
            [
              _c("item-icon", [_vm._t("icon")], 2),
              _vm._v(" "),
              _c("item-text", [_vm._t("default")], 2),
            ],
            1
          ),
        ],
    ...
    var boardItemLabelProps = {
      fontSize: {
        type: Number,
        default: 14
      }
    };
    var boardItemValueProps = {
      fontSize: {
        type: Number,
        default: 18
      }
    };
    var boardItemShadowProps = {
      color: {
        type: String,
        default: '#28f8ff'
      }
    };
    var BoardContainer = styled.div(_templateObject$2 || (_templateObject$2 = _taggedTemplateLiteral(["\n    position: relative;\n    width: 100%;\n    height: 100%;\n    overflow: hidden;\n"])));
    var BoardItem = styled('div', boardItemProps)(_templateObject2$1 || (_templateObject2$1 = _taggedTemplateLiteral(["\n    position: relative;\n    height: ", "px;\n    width: 100%;\n    display: flex;\n    align-items: center;\n    color: ", ";\n    transition: all 0.3s;\n    overflow: hidden;\n    cursor: pointer;\n    //background: #0070c342;\n    padding: 0 10px;\n    box-sizing: border-box;\n"])), function (props) {
      return props.height;
    }, function (props) {
      return props.color;
    });
    var BoardItemIcon = styled('div', boardItemIconProps)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n    font-family: 'electronic';\n    width: 50px;\n    color: ", ";\n    font-size: ", "px;\n"])), function (props) {
      return props.color;
    }, function (props) {
      return props.fontSize;
    });
    var BoardItemLabel = styled('div', boardItemLabelProps)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n    flex: 1;\n    font-size: ", "px;\n"])), function (props) {
      return props.fontSize;
    });
    var BoardItemValue = styled('div', boardItemValueProps)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n    font-family: 'electronic';\n    font-size: ", "px;\n"])), function (props) {
      return props.fontSize;
    });
    var BoardItemShadow = styled('div', boardItemShadowProps)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n        position: absolute;\n        left: 0;\n        bottom: 5px;\n        height: 5px;\n        width: 0;\n        transform: translateX(-50%);\n        background: radial-gradient(", " 5%,transparent 80%);\n        animation: shadow 3s linear infinite;\n\n        @keyframes shadow {\n            0% {\n                width: 20%;\n            }\n            50% {\n                width: 200%;\n            }\n            100% {\n                width: 20%;\n            }\n        }\n"])), function (props) {
      return props.color;
    });
    ...
    var script$1 = {
      ...
      components: {
        ...
        BoardItemIcon: BoardItemIcon,
        BoardItemLabel: BoardItemLabel,
        BoardItemValue: BoardItemValue,
        BoardItemShadow: BoardItemShadow
      },
      props: {
        /**
        * @description 数据
      ...
      mounted: function mounted() {
        ...
        this.$nextTick(function () {
          var dom = _this.$refs[_this.ref];
          dom === null || dom === void 0 ? void 0 : dom.$el.addEventListener('mouseenter', function () {
            clearInterval(_this.timer);
          });
          dom === null || dom === void 0 ? void 0 : dom.$el.addEventListener('mouseleave', function () {
            _this.animation();
          });
        });
      },
      computed: {
         ...
         * @description 高亮颜色
         */
        defaultHighlightColor: function defaultHighlightColor() {
      ...
      methods: {
        ...
        animation: function animation() {
          ...
          this.timer = setInterval(function () {
            var newData = _toConsumableArray$1(_this3.allData);
            // 将即将要删除的元素高度设置为0
            newData.forEach(function (item, i) {
              if (i < _this3.scrollNum) {
                item.height = 0;
              }
            });
            // 将即将要删除的数据添加到最后
            newData = [].concat(_toConsumableArray$1(newData), _toConsumableArray$1(newData.slice(0, _this3.scrollNum).map(function (item) {
              return _objectSpread2$1(_objectSpread2$1({}, item), {}, {
                height: _this3.avgHeight,
                scroll: item.scroll + _this3.rowNum
              });
            })));
            // 新数据保存到allData中
            _this3.allData = newData;
            // domData重新计算
            _this3.domData = newData.slice(0, _this3.rowNum + _this3.scrollNum);

            // 300ms后分别将allData及domData中需要删除的删除
            setTimeout(function () {
              newData = _toConsumableArray$1(_this3.allData);
              // 删除数组中需要删除的元素
              newData = newData.slice(_this3.scrollNum);
              _this3.allData = newData;
              newData = _toConsumableArray$1(_this3.domData);
              // 删除数组中需要删除的元素
              newData = newData.slice(_this3.scrollNum);
              _this3.domData = newData;
            }, 300);
          }, this.interval);
        }
      }
    ...
    var __vue_render__$1 = function () {
      ...
      return _c(
        "board-container",
        { ref: _vm.ref, class: _vm.ref },
        _vm._l(_vm.domData, function (item, index) {
          return _c(
            "board-item",
            {
              key: item.label + item.ranking + item.scroll,
              attrs: { height: item.height, color: _vm.color },
              on: {
                click: function () {
                  return _vm.handleRowClick(item, index)
                },
              },
            },
            [
              _c(
                ...
                {
                  attrs: {
                    "font-size": _vm.rankingFontSize,
                    color: _vm.getHighlightColor(item),
                  },
                },
              ...
              _c(
                "board-item-label",
                { attrs: { "font-size": _vm.labelFontSize } },
                [_vm._v(_vm._s(item.label))]
              ),
              _vm._v(" "),
              _c(
                "board-item-value",
                { attrs: { "font-size": _vm.valueFontSize } },
                [_vm._v(_vm._s(item.value))]
              ),
              _vm._v(" "),
              _vm.highlightRowNum >= item.ranking
                ? _c("board-item-shadow", {
                    attrs: { color: _vm.getHighlightColor(item) },
                  })
                : _vm._e(),
            ],
            1
    ...
    function EScrollRankingBoard (Vue) {
    ...
    var TextContainer = styled('div', textContainerProps)(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral(["\n    color: ", ";\n\n    @keyframes text-gradient {\n        to {\n            color: ", ";\n        }\n    }\n"])), function (props) {
      return props.colors[0];
    }, function (props) {
      return props.colors[1];
    });
    var Text = styled('span', textProps)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n    \n    animation: text-gradient ", "s linear ", "s infinite alternate;\n    margin: 0 ", "px;\n"])), function (props) {
      return props.duration;
    }, function (props) {
      return props.delay;
    }, function (props) {
    ...
    var __vue_render__ = function () {
      ...
      return _c(
        ...
        _vm._l(_vm.spans, function (txt, index) {
          return _c(
            "e-text",
            {
              key: "" + _vm.spans.length + index,
              attrs: {
                spacing: _vm.spacing,
                duration: _vm.spans.length * _vm.speed,
                delay: index * _vm.speed,
              },
            },
            [_vm._v(_vm._s(txt))]
          )
